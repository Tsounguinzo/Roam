...
2.  Clone your forked repository to your local machine:
    ...
    ```bash
    git clone https://github.com/your-name/Roam.git
    ```
...
## Development
- Install rust and tauri refer to this [link](https://tauri.app/start/prerequisites/)
...
``` 
- Note: 
  - for build release we use github actions to build the project and upload the build to github release. You can check the build [workflow here](https://github.com/Tsounguinzo/Roam/blob/main/.github/workflows/release.yml)
