...
function SettingToggleRow({ title, description, checked = false, dispatchType, component }: SettingToggleRowProps) {
    return (
        <Box className="flex items-center justify-between gap-[18px] border-b-2 border-dashed border-[rgba(32,38,47,0.14)] px-4 py-[18px] last:border-b-0 max-[760px]:items-start">
